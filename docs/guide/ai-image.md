...
![Image](/images/ai-image/ai-image-01-eca63f16.webp)

2. 找到合适的样例后点击“复制”按钮，即可复制完整提示词，然后点击“试一试”按钮跳转到生图工具。在对话框输入生图提示词。

![Image](/images/ai-image/ai-image-02-cf2029b4.webp)

3. 然后点击右上角的设置按钮，把在[API密钥界面](https://1token-store.com/keys)申请到的密钥填入。

![Image](/images/ai-image/ai-image-03-1c398b32.webp)

4. 在聊天窗口点击发送按钮，耐心等待即可得到你的作品。

![Image](/images/ai-image/ai-image-04-e7102a77.webp)
